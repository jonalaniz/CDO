...
final class ClientSACell: BaseCell<SADetail> {
    ...
    static var height: CGFloat {
        let headerHeight = NSFont.preferredFont(forTextStyle: .headline).boundingRectForFont.height
        let descriptionHeight = NSFont.preferredFont(forTextStyle: .body).boundingRectForFont.height
        return headerHeight + descriptionHeight + 25
    }
    ...
    override func layoutCell() {
        ...
        NSLayoutConstraint.activate([
            ...
            descriptionField.topAnchor.constraint(equalTo: headerStack.bottomAnchor, constant: 8),
